...
public class StepDefinition {
	...
	public void clico_no_botao_Create_an_account() throws Throwable {
	...
	@When("^seleciono mes 'Date of Birth' \"([^\"]*)\"$")
	public void seleciono_mes_Date_of_Birth(String monthDateOfBirth) throws Throwable {
